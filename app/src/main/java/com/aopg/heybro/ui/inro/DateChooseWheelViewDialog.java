package com.aopg.heybro.ui.inro;
...
//                mDateCalendarTextView.setText(" " + arry_date.get(wheel.getCurrentItem()));
    ...
    private void initView() {
        View view = LayoutInflater.from(mContext).inflate(R.layout.fragment_my_ziliao_choose, null);
    ...
    private class CalendarTextAdapter extends AbstractWheelTextAdapter {
        ...
        protected CalendarTextAdapter(Context context, ArrayList<String> list, int currentItem, int maxsize, int minsize) {
            super(context, R.layout.my_ziliao_item_birth_year, R.id.tempValue, currentItem, maxsize, minsize);
            this.list = list;
        }
